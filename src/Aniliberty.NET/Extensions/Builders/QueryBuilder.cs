...
namespace AniLiberty.NET.Extensions.Builders
{
    public class QueryBuilder
    {
        public static string Build(ReleaseQueryDto parametrs, ILogger<QueryBuilder>? logger = null)
        {
            try
            {
                ...
                if (parametrs.MinYearOfRelease != null) query.Add($"f[years][from_year]={parametrs.MinYearOfRelease}");
                if (parametrs.MaxYearOfRelease != null) query.Add($"f[years][to_year]={parametrs.MaxYearOfRelease}");
