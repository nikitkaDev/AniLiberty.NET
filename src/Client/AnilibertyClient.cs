...
using AniLiberty.NET.src.Extensions.Builders;
using System.Text.Json;
using System.Xml;
using Microsoft.Extensions.Logging;
using System.Text.Json.Serialization;
using AniLiberty.NET.src.Models.Shorts;
using AniLiberty.NET.src.Models.Core.Base;
using AniLiberty.NET.src.Models.Core.Сustom;
using AniLiberty.NET.src.Models.Entities.API;
using AniLiberty.NET.src.Models.Entities.Franchises;
using AniLiberty.NET.src.Models.Entities.Members;
using AniLiberty.NET.src.Models.Entities.Releases;
using AniLiberty.NET.src.Models.Responses.Anime.Franchises;
using AniLiberty.NET.src.Models.Responses.Anime.Releases;
using AniLiberty.NET.src.Models.Responses.Anime.Releases.Episodes;
using AniLiberty.NET.src.Models.Responses.Anime.Releases.Schedule;
using AniLiberty.NET.src.Models.Responses.Anime.Torrents;
using AniLiberty.NET.src.Models.Responses.Generic;
using AniLiberty.NET.src.Models.Responses.Media.Promotions;
using AniLiberty.NET.src.Models.Responses.Media.Videos;
using AniLiberty.NET.src.Models.Responses.Teams;

namespace AniLiberty.NET.src.Client
{
